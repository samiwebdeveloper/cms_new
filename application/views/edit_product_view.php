							...
							<div class="col-md-5" id="f_panel">
								<div class="card m-t-10">
									...
									<div class="card-body">
										...
										<?php
										$action_path = "Add_product/edit_master_detail_row";
										...
										<form enctype="multipart/form-data" id="add_name" class="row  needs-validation" novalidate method="POST" action="<?php echo base_url() . $action_path ?>">
											...
											<div class="col-md-6 my-3 form-floating ">
												<select name="CategoryId" required class="form-select" id="category_select">
													<option value="" selected>Select Parent Category</option>
													<?php foreach ($fetch_data_d as $item) {
														$selected = "";
														if ($get_event_data[0]['CategoryId'] == $item->CategoryId) {
															$selected = "selected";
														}
														echo '<option ' . $selected . ' value="' . $item->CategoryId . '">' . $item->Category . '</option>';
													} ?>
												</select>
											...
											<div class="col-md-6 my-3 form-floating ">
												<select name="status" required class="form-select" id="category_select1">
												...
												<label for="category_select1">Select Status</label>
												<div class="valid-tooltip">Looks good!</div>
												<div class="invalid-tooltip">This Field Is Required!</div>
												</div>

											<div class="col-md-12 my-3 form-floating ">
												<textarea class="form-control" style="height:100px ;" name="Description" placeholder="Leave a Detail here" id="floatingTextarea2" required> <?php echo $Description ?></textarea>
											...
											<div class="col-md-6 my-3 form-floating ">
												<input type="number" value="<?php echo $XPrice ?>" class="form-control" name="XPrice" id="floatingInput" placeholder="name@example.com" required>
												<label for="validationTooltip01" class="form-label">XPrice</label>
												<div class="valid-tooltip">Looks good!</div>
												<div class="invalid-tooltip">This Field Is Required!</div>
											</div>

											<div class="col-md-6 my-3 form-floating ">
												<input type="number" class="form-control" value="<?php echo $Price ?>" name="Price" id="floatingInput" placeholder="name@example.com" required>
												...
												<div class="col-md-12 my-3 form-floating ">
													...
													<table class="table table-bordered">
														...
														<?php foreach ($get_event_img_data as $key => $item) {
															$EventImageId = $item['ProductImageId'];
															$Image = $item['Image'];
												...
												<tbody>
													...
													?>
														<tr>
															...
															<td><?php echo $i ?></td>
															<td class="text-center " style="cursor:pointer;" data-toggle="modal" data-target="#edit_<?php echo $EventImageId ?>"><img width="30px" height="30px" src="<?php echo base_url(); ?>assets/upload_product/<?php echo $Image ?>" alt="<?php echo $Alternative ?>"> </td>
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<img width="100%" height="80%" src="<?php echo base_url(); ?>assets/upload_product/<?php echo $Image ?>" alt="$Alternative">
																	</div>
																	<!-- Modal footer -->
