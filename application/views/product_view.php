							...
							<div class="col-md-5" id="f_panel">
								<div class="card m-t-10">
									...
									<div class="card-body">
										...
										<?php
										$action_path = "Add_product/insert_data";
										?>
										<form enctype="multipart/form-data" id="add_name" class="row  needs-validation" novalidate method="POST" action="<?php echo base_url() . $action_path ?>">
											...
											<div class="col-md-12 my-3 form-floating ">
												<select name="ParentId" required class="form-select" id="category_select">
											...
											<div class="col-md-12 my-3 form-floating ">
												<textarea class="form-control" style="height:100px ;" name="Description" placeholder="Leave a Detail here" id="floatingTextarea2" required></textarea>
											...
											<div class="col-md-6 my-3 form-floating ">
												<input type="number" class="form-control" name="XPrice" id="floatingInput" placeholder="name@example.com" required>
											...
											<div class="col-md-6 my-3 form-floating ">
												<input type="number" class="form-control" name="Price" id="floatingInput" placeholder="name@example.com" required>
												...
												<tbody>
													...
													?>
														<tr>
															...
															<td><?php echo $i ?></td>
															<td><?php echo $row_parent_categpry[$CategoryId] ?> </td>
															<td><?php echo $Description ?> </td>
															<td><?php echo $XPrice ?> </td>
															<td><?php echo $Price ?> </td>
															<?php if ($Status) {
																echo "<td class='bg-success'><b>Active </b></td>";
															} else {
																echo "<td class='bg-danger'><b> DeActive </b></td>";
															} ?>
															<td hidden> <input type="number" hidden class="row_id " value="<?php echo $EventId ?>"></td>


															<td class="text-center ">
																<a data-toggle="tooltip" data-placement="top" title="Click And View Detail" class="edit_btn btn btn-info btn-sm" href="<?php echo base_url() ?>Add_product/edit_master_detail/<?php echo $EventId ?>"><i class="fa fa-eye"></i></a>
																<a class="edit_btn btn btn-success btn-sm" href="<?php echo base_url() ?>Add_product/edit_master_detail/<?php echo $EventId ?>"><i class="fa fa-edit"></i></a>
																...
																<div class="modal-dialog" role="document">
																	<div class="modal-content">
																		...
																		<div class="modal-footer">
																			...
																			<a type="button" href="<?php echo base_url() ?>Add_product/delete_record/<?php echo $EventId ?>" class="btn btn-danger">Delete</a>
...
<script>
	$(".edit_dc").click(function() {
		...
		$(".pickvalue").keypress(function(event) {
			...
			if (keycode == '13') {
				$.ajax({
					url: "Add_product/update_sorting",
					method: "POST",
					data: mydata,
					beforeSend: function() {
