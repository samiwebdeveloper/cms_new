<!DOCTYPE html>
<html data-style-switcher-options="{'changeLogo': false, 'colorPrimary': '#0088cc', 'colorSecondary': '#0169fe', 'colorTertiary': '#2baab1', 'colorQuaternary': '#383f48'}">
<!-- Mirrored from www.okler.net/previews/porto/9.7.0/demo-one-page-agency.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 12:28:28 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/website_assets/img/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/website_assets/img/apple-touch-icon.png">
    <!-- Mobile Metas -->
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/animate/animate.compat.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/simple-line-icons/css/simple-line-icons.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/owl.carousel/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/owl.carousel/assets/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/vendor/magnific-popup/magnific-popup.min.css">
    <!-- Theme CSS -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/theme.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/theme-elements.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/theme-blog.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/theme-shop.css">
    <!-- for 2nd template css -->
    <!-- Demo CSS -->
    <!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/demos/demo-one-page-agency.css"> -->
    <!-- Skin CSS -->
    <!-- <link id="skinCSS" rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/skins/skin-one-page-agency.css"> -->

    <link id="skinCSS" rel="stylesheet" href="<?php echo base_url(); ?>assets/website_assets/css/skins/default.php">
    <!-- Head Libs -->
    <script src="<?php echo base_url(); ?>assets/website_assets/vendor/modernizr/modernizr.min.js"></script>
    ...
    <div class="body">
                            ...
                            <div class="header-row">
                                <div class="header-logo px-4">
                                    <a href="demo-one-page-agency.html">
                                        <img alt="Porto One Page Agency" width="123" height="33" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/logo.png">
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1">
                                        ...
                                        <nav class="wrapper-spy collapse">
                                            <ul class="nav nav-pills" id="mainNav">
                                                ...
                                                <li>
                                                    <a class="nav-link" href="#gallery" data-hash data-hash-offset="0" data-hash-offset-lg="32">
                                                        Gallery
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="nav-link" href="#events" data-hash data-hash-offset="0" data-hash-offset-lg="32">
                                                        Events
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="nav-link" href="#Products" data-hash data-hash-offset="0" data-hash-offset-lg="32">
                                                        Products
                                                    </a>
                                                </li>
                                                <li>
                        ...
                        <div class="header-column w-100pct w-lg-25pct justify-content-end">
                            <div class="header-row px-4">
                                <div class="d-none d-sm-flex align-items-center">
                                    <img width="30" height="30" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/phone.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light me-1'}" />
                                    <a href="tel:1234567890" class="text-color-light font-weight-semibold opacity-hover-9 text-decoration-none">(800) 123-4567</a>
                                </div>
        ...
        <div role="main" class="main">
            <div class="position-relative">
                <div class="d-none d-sm-block position-absolute top-50pct transform3dy-n50 right-15 z-index-3 pe-3">
                    <ul class="d-flex flex-column social-icons social-icons-clean social-icons-icon-light social-icons-medium">
                        <li class="social-icons-instagram">
                            <a href="https://www.instagram.com/" class="text-color-quaternary" target="_blank" title="Instagram">
                ...
                <!-- carousel start -->
                <?php if (count($fetch_slider) > 0) { ?>
                    <div id="home" class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual custom-dots-style-1 dots-inside dots-horizontal-center show-dots-hover show-dots-xs dots-light nav-style-1 nav-inside nav-inside-plus nav-light nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 6000, 'autoplay': true}" style="height: 80vh;">
                        <div class="owl-stage-outer">
                            <div class="owl-stage">
                                <!-- Carousel Slide 1 -->
                                <!-- <div class="owl-item position-relative">
                                <div class="background-image-wrapper position-absolute top-0 left-0 right-0 bottom-0 animated kenBurnsToRightTop" style="background-image: url(<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/slides/slide-1.jpg); background-size: cover; background-position: center; animation-duration: 20s;"></div>
                                        ...
                                        <div class="col-lg-7 text-center text-sm-start mb-4 pb-5 pb-lg-0">
                                            ...
                                            <h1 class="d-inline-block text-color-light font-weight-bold text-11 text-sm-13 text-md-14 line-height-1 position-relative mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
                                                ...
                                                <span class="custom-highlight-text-1 alternative-font-3 text-color-secondary d-none d-md-block">
                                                    <span data-plugin-animated-letters data-plugin-options="{'startDelay': 2200, 'minWindowWidth': 0}">revisited</span>
                                                    <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/blue-line.png" class="img-fluid appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="3000" data-appear-animation-duration="2s" alt="" />
                                                </span>
                                            </h1>
                                            <p class="text-4 text-color-grey w-sm-75pct pe-md-5 pe-lg-0 pe-xl-5 pb-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Porto is simply the best choice for your new website. The most complete package in the world. </p>
                                            <a href="#who-we-are" class="btn btn-gradient custom-btn-effect-1 custom-border-radius-1 d-inline-flex align-items-center font-weight-semibold text-3-5 btn-px-5 btn-py-3 appear-animation" data-hash data-hash-offset="0" data-hash-offset-lg="32" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600" data-appear-animation-duration="1.7s">
                                                GET STARTED
                                                <img width="15" height="15" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/arrow-down.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'removeClassAfterInit': 'fadeIn', 'extraClass': 'svg-fill-color-light position-relative bottom-1 ms-4'}" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                ?>
                                    <div class="owl-item position-relative" style="background-image: url(<?php echo base_url() ?>assets/upload_sliders/<?php echo $Image ?>); background-size: cover; background-position: center;">
                                        <div class="container position-relative z-index-3 h-100">
                                            <div class="row justify-content-center align-items-center h-100">
                                                ...
                                                PORTO AGENCY - NEW YORK / NY
                                                    ...
                                                    <p class="text-4 text-color-grey px-md-5 pb-3 mx-md-5 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">
                                                        <?php echo  $Detail; ?>.
                                                    </p>
                                                    <a href="#who-we-are" class="btn btn-gradient custom-btn-effect-1 custom-border-radius-1 d-inline-flex align-items-center font-weight-semibold text-3-5 btn-px-5 btn-py-3 appear-animation" data-hash data-hash-offset="0" data-hash-offset-lg="32" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600" data-appear-animation-duration="1.7s">
                                                        GET STARTED
                        ...
                        <div class="owl-dots mb-5">
                            <?php
                            for ($i = 0; $i < count($fetch_slider); $i++) {
                                if ($i == 0) {
                                    echo '<button role="button" class="owl-dot active"><span></span></button>';
                                } else {
                                    echo '<button role="button" class="owl-dot"><span></span></button>';
                                }
                            }
                            ?>
                        </div>
                ...
                <section class="section section-primary border-top-0 mb-0 mt-0 ">
                    <div class="container">
            ...
            <section id="who-we-are" class="section section-height-3 bg-transparent border-0 m-0">
                <div class="container py-4">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6 pe-lg-5 mb-5 mb-lg-0">
                            ...
                            <p class="text-color-dark custom-font-secondary text-5-5 line-height-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Lorem ipsum dolor sit a met, consectetur adipiscing elit morbi imperdiet libero. </p>
                            <p class="text-3-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            <a href="#what-we-do" class="d-inline-flex align-items-center text-color-primary font-weight-bold text-4 text-decoration-none custom-link-effect-1 appear-animation" data-hash data-hash-offset="0" data-hash-offset-lg="32" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
                                Find Out More
                                <img width="15" height="15" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/arrow-down.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'removeClassAfterInit': 'fadeIn', 'extraClass': 'svg-fill-color-primary ms-2'}" />
                            </a>
                        </div>
                        <div class="col-5 col-sm-7 col-md-12 col-lg-6 text-center">
                            <div class="position-relative d-inline-flex">
                                <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/generic/generic-2-small.jpg" class="img-fluid rounded-circle box-shadow-5 position-absolute top-50pct transform3dy-n50 z-index-3" alt="" style="right: 75%;" />
                                <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/generic/generic-3-small.jpg" class="img-fluid rounded-circle box-shadow-5 z-index-2" width="260" alt="" />
                                <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/generic/generic-1-small.jpg" class="img-fluid rounded-circle box-shadow-5 position-absolute top-50pct transform3dy-n50 z-index-1" alt="" style="left: 75%;" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container pt-2">
                    ...
                    <div id="our-team" class="row align-items-cente page-header page-header-modern bg-color-light-scale-1 page-header-mdr">
                        <div class="col">
                            <div class="row">
                                <div class="col-md-12 align-self-center p-static order-2 text-center">
                                    <div class="overflow-hidden pb-2">
                                        <h1 class="text-dark font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">Our Team</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pb-5">
                            ...
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <a href="about-me.html">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/team/team-1.jpg" class="img-fluid" alt="">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <a href="about-me.html">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/team/team-2.jpg" class="img-fluid" alt="">
                                        <span class="thumb-info-title">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-4 mb-sm-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <a href="about-me.html">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/team/team-3.jpg" class="img-fluid" alt="">
                                        <span class="thumb-info-title">
                        ...
                        <div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <a href="about-me.html">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/team/team-4.jpg" class="img-fluid" alt="">
                                        <span class="thumb-info-title">
                ...
                <div class="container py-3">
                    <div class="row counters text-center">
                        <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="500">
                            <img width="95" height="95" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/bubble.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light mb-2'}" />
                            <div class="counter">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="300">
                            <img width="95" height="95" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/star.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light mb-2'}" />
                            <div class="counter">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-5 mb-sm-0 appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="300">
                            <img width="95" height="95" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/add-user.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light mb-2'}" />
                            <div class="counter">
                                <strong class="text-color-light text-10 negative-ls-2" data-to="40000" data-append="+">0</strong>
                        ...
                        <div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="500">
                            <img width="95" height="95" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/code.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light mb-2'}" />
                            <div class="counter">
            ...
            <section id="what-we-do" class="section bg-transparent overflow-hidden border-0 m-0 pb-0">
                <div class="container pt-5 mt-2">
                    <div class="row align-items-cente page-header page-header-modern bg-color-light-scale-1 page-header-mdr">
                        <div class="col">
                            <div class="row">
                                <div class="col-md-12 align-self-center p-static order-2 text-center">
                                    <div class="overflow-hidden pb-2">
                                        <h1 class="text-dark font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">Our Services</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-xl-4 pe-lg-4 pe-xl-0 pb-lg-5 mb-5 mb-xl-0">
                            <div class="pe-5">
                                <div class="d-flex">
                                    <img width="40" height="40" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/seo-edit.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
                                    <div class="ms-4">
                                        <h4 class="font-weight-bold text-5 mb-2">Web Design</h4>
                                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro dolorem et ut praesentium consectetur? </p>
                                    </div>
                                </div>
                                <div class="d-flex my-3">
                                    <img width="40" height="40" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/seo-notebook.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
                                    <div class="ms-4">
                                ...
                                <div class="d-flex">
                                    <img width="40" height="40" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/icons/seo-phone-tablet.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
                                    <div class="ms-4">
                                        <h4 class="font-weight-bold text-5 mb-2">Mobile Apps</h4>
                                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, nam harum eos sunt. Lorem ipsum dolor sit a met. </p>
                                    </div>
                                </div>
            ...
            <div role="main" class="main">
                <div class="container" id="Products">
                    <div class="col-auto">
                        <div class="overflow-hidden">
                            <h2 class="text-color-primary font-weight-semibold line-height-7 text-3 positive-ls-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">Our Available</h2>
                        </div>
                        <div class="overflow-hidden mb-4">
                            <h3 class="text-color-dark font-weight-bold text-transform-none line-height-1 text-10 pe-1 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Products</h3>
                        </div>
                    </div>
                    <ul class="nav nav-pills sort-source sort-source-style-3 justify-content-center" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*'}">
                        <li class="nav-item line-height-1 active" data-option-value="*">
                            <a class="nav-link text-1  font-weight-semibold text-color-hover-primary active" href="javascript:avoid(0)">Show All</a>
                        </li>
                        ...
                        foreach ($category_unique as $category_value) {
                            echo '<li class="nav-item line-height-1" data-option-value=".' . $row_parent_categpry[$category_value] . '">
                            <a class="nav-link text-1 font-weight-semibold text-color-hover-primary " href="#">' . $row_parent_categpry[$category_value] . '</a>
                            </li>';
                        }
                        ?>
                                                ...
                                                <div class="container-fluid shadow-lg" style="background-color:white ;">
                                                    ...
                                                    <div class="row pb-4 ">
                                                        <div class="col-sm-4 my-1">
                                                            ...
                                                            <hr>
                                                            <div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'autoplay': true, 'autoplayTimeout': 3000, 'margin': 10, 'animateIn': 'slideInDown', 'animateOut': 'slideOutDown'}">
                                                                <?php
                                                                foreach ($fetch_product_img as $product_img) {
                                                                    if ($ProductId == $product_img['ProductId']) {
                                                                        $product_img = $product_img['Image'];
                                                                        echo '<div><img alt="" class="img-fluid rounded" style="height:85% !important ;" src="' . base_url() . 'assets/upload_product/' . $product_img . '" class="img-fluid" alt=""></div>';
                                                                    }
                                                                } ?>
                                                            </div>
                                                        </div>
            ...
            <!-- project end -->
<!-- gallery start -->
<section id="gallery" class="section bg-transparent border-0 m-0 pb-0">
    <div class="container pt-4">
        <div class="row align-items-cente page-header page-header-modern bg-color-light-scale-1 page-header-mdr">
            <div class="col">
                <div class="row">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <div class="overflow-hidden pb-2">
                            <h1 class="text-dark font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100"> Our Gallery</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-between align-items-end mb-3">
            <div class="col-auto">
                ...
                <div class="overflow-hidden mb-4">
                    <h3 class="text-color-dark font-weight-bold text-transform-none line-height-1 text-10 pe-1 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Gallery</h3>
                </div>
            </div>
                    ...
                    <div id="portfolioLoadMoreWrapper" class="row image-gallery sort-destination lightbox" data-sort-id="portfolio" data-total-pages="3" data-ajax-url="ajax/demo-one-page-agency-ajax-load-more-" data-plugin-options="{'delegate': 'a.lightbox-portfolio', 'type': 'image', 'gallery': {'enabled': true}}" style="height: 49.55vw;">
                        <div class="isotope-item col-sm-6 col-lg-3 website p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 brands p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-3.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-3.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 mobile-app p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-4.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-4.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 others p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-5.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-5.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 website p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-6.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-6.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 website p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-25.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-25.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 others p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-7.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-7.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
                        ...
                        <div class="isotope-item col-sm-6 col-lg-3 brands p-0">
                            <div class="image-gallery-item mb-0">
                                <a href="<?php echo base_url(); ?>assets/website_assets/img/Products/project-1.jpg" class="lightbox-portfolio">
                                    <span class="thumb-info thumb-info-centered-info thumb-info-no-borders custom-thumb-info-style-1">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/Products/project-1.jpg" class="img-fluid" alt="">
                                            <span class="thumb-info-title">
...
<!-- gallery end -->
            ...
            <section id="cases" class="section border-0 m-0">
                <div class="container pt-3 pb-4">
                    <div class="row mb-2">
                        <div class="col">
                            <div class="overflow-hidden">
                                <h2 class="text-color-primary font-weight-semibold line-height-7 text-3 positive-ls-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">Products</h2>
                            </div>
                            <div class="overflow-hidden mb-4">
                    ...
                    <div class="row">
                        <div class="col appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
                            <div class="owl-carousel carousel-shadow-1 show-nav-title custom-dots-style-1 dots-dark" data-plugin-options="{'responsive': {'479': {'items': 1}, '768': {'items': 1}, '979': {'items': 2}, '1199': {'items': 2}, '1440': {'items': 2}}, 'margin': 20, 'loop': false, 'dots': true, 'dotsVerticalOffset': '30px', 'nav': false}">
                                <div>
                                    <a href="<?php echo base_url(); ?>assets/website_assets/ajax/portfolio-ajax-project-1.html" class="text-decoration-none" data-ajax-on-modal>
                                        <article>
                                            <div class="card border-0 border-radius-0 p-1">
                                                <div class="card-body p-3 z-index-1">
                                                    <img class="card-img-top border-radius-0 opacity-hover-8 mb-2" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/cases/case-1.jpg" alt="Card Image">
                                ...
                                <div>
                                    <a href="<?php echo base_url(); ?>assets/website_assets/ajax/portfolio-ajax-project-2.html" class="text-decoration-none" data-ajax-on-modal>
                                        <article>
                                            <div class="card border-0 border-radius-0 p-1">
                                                <div class="card-body p-3 z-index-1">
                                                    <img class="card-img-top border-radius-0 opacity-hover-8 mb-2" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/cases/case-2.jpg" alt="Card Image">
                                                    <p class="text-uppercase text-color-default text-1 mb-1">WEBSITE</p>
                                                    <div class="card-body p-0">
                                ...
                                <div>
                                    <a href="<?php echo base_url(); ?>assets/website_assets/ajax/portfolio-ajax-project-3.html" class="text-decoration-none" data-ajax-on-modal>
                                        <article>
                                            <div class="card border-0 border-radius-0 p-1">
                                                <div class="card-body p-3 z-index-1">
                                                    <img class="card-img-top border-radius-0 opacity-hover-8 mb-2" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/cases/case-1.jpg" alt="Card Image">
            ...
            <section class="section parallax border-0 p-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'scrollableParallax': true, 'scrollableParallaxMinWidth': 991, 'startOffset': 5, 'cssProperty': 'width', 'cssValueStart': 40, 'cssValueEnd': 100, 'cssValueUnit': 'vw'}" data-image-src="<?php echo base_url(); ?>assets/website_assets/img/blank.gif">
                        ...
                        <div class="container custom-container-style-3 custom-container-position-1 py-5 mx-0">
                            <div class="row align-items-center">
                                <div class="col-lg-6 mb-5 mb-lg-0">
                                    <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/mockup.png" alt="" class="img-fluid" />
                                </div>
                                <div class="col-lg-6">
            ...
            <section id="events" class="section section-height-3 bg-transparent border-0 m-0">
                <div class="container pb-4">
                    <div class="row align-items-cente page-header page-header-modern bg-color-light-scale-1 page-header-mdr">
                        <div class="col">
                            <div class="row">
                                <div class="col-md-12 align-self-center p-static order-2 text-center">
                                    <div class="overflow-hidden pb-2">
                                        <h1 class="text-dark font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">News & Events</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="overflow-hidden">
                                <h2 class="text-color-primary font-weight-semibold text-3 line-height-7 positive-ls-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">Vip Events</h2>
                            </div>
                            <div class="overflow-hidden mb-4">
                                <h3 class="text-color-dark font-weight-bold text-transform-none line-height-1 text-10 pe-1 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">News & Events</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
                                ...
                                <div class="owl-carousel carousel-shadow-1 carousel-shadow-1-bold owl-theme dots-horizontal-center custom-dots-style-1 dots-dark mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 2}, '992': {'items': 2}, '1200': {'items': 3}, '1440': {'items': 3}}, 'margin': 20, 'loop': false, 'nav': false, 'dots': true, 'dotsVerticalOffset': '30px', 'autoplay': false, 'autoplayTimeout': 7000}">
                                    <a href="#team-content-1" class="popup-with-zoom-anim text-decoration-none">
                                        <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/team/team-1.jpg" class="card-img-top border-radius-0 opacity-hover-8" alt="John Doe Image" />
                                    ...
                                    <a href="#team-content-2" class="popup-with-zoom-anim text-decoration-none">
                                        <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/team/team-2.jpg" class="card-img-top border-radius-0 opacity-hover-8" alt="John Doe Image" />
                                            <div class="card-body text-center px-4 py-5">
                                    ...
                                    <a href="#team-content-3" class="popup-with-zoom-anim text-decoration-none">
                                        <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                                            <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/team/team-3.jpg" class="card-img-top border-radius-0 opacity-hover-8" alt="John Doe Image" />
                                            <div class="card-body text-center px-4 py-5">
                            ...
                            <div id="team-content-1" class="dialog dialog-sm zoom-anim-dialog mfp-hide mfp-close-out p-4">
                                <div class="row mt-1">
                                    <div class="col px-3 mb-4 mb-md-0">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/team/team-1.jpg" class="custom-rounded-image img-fluid mb-4" alt="">
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col px-3">
                            ...
                            <div id="team-content-2" class="dialog dialog-sm zoom-anim-dialog mfp-hide mfp-close-out p-4">
                                <div class="row mt-1">
                                    <div class="col px-3 mb-4 mb-md-0">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/team/team-2.jpg" class="custom-rounded-image img-fluid mb-4" alt="">
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col px-3">
                            ...
                            <div id="team-content-3" class="dialog dialog-sm zoom-anim-dialog mfp-hide mfp-close-out p-4">
                                <div class="row mt-1">
                                    <div class="col px-3 mb-4 mb-md-0">
                                        <img src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/team/team-3.jpg" class="custom-rounded-image img-fluid mb-4" alt="">
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col px-3">
                                        ...
                                        <div class="card border-0 border-radius-0 p-1">
                                            <div class="card-body p-3 z-index-1">
                                                <a href="blog-post.html" class="d-block opacity-hover-8">
                                                    <img class="card-img-top border-radius-0 mb-2" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/blog/blog-1.jpg" alt="Card Image">
                                                </a>
                                                <p class="text-uppercase text-color-default text-1 my-2 pb-1">
                                                    <time pubdate datetime="2022-01-10">10 Jan 2022</time>
                                                    <span class="opacity-3 d-inline-block px-2">|</span> 3 Comments
                                ...
                                <div>
                                    <article>
                                        <div class="card border-0 border-radius-0 p-1">
                                            <div class="card-body p-3 z-index-1">
                                                <a href="blog-post.html" class="d-block opacity-hover-8">
                                                    <img class="card-img-top border-radius-0 mb-2" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/blog/blog-2.jpg" alt="Card Image">
                                                </a>
                                                <p class="text-uppercase text-color-default text-1 my-2 pb-1">
                                                    <time pubdate datetime="2022-01-10">10 Jan 2022</time>
                                                    <span class="opacity-3 d-inline-block px-2">|</span> 3 Comments
                                ...
                                <div>
                                    <article>
                                        <div class="card border-0 border-radius-0 p-1">
                                            <div class="card-body p-3 z-index-1">
                                                <a href="blog-post.html" class="d-block opacity-hover-8">
                                                    <img class="card-img-top border-radius-0 mb-2" src="<?php echo base_url(); ?>assets/website_assets/img/demos/one-page-agency/blog/blog-3.jpg" alt="Card Image">
                                                </a>
                                                <p class="text-uppercase text-color-default text-1 my-2 pb-1">
                                                    <time pubdate datetime="2022-01-10">10 Jan 2022</time>
                                                    <span class="opacity-3 d-inline-block px-2">|</span> 3 Comments
                ...
                <div class="container py-4">
                    <div class="row align-items-center text-center">
                        <div class="col-sm-4 col-xl-2 mb-5 mb-xl-0">
                            <img src="<?php echo base_url(); ?>assets/website_assets/img/logos/logo-8.png" alt class="img-fluid" style="max-width: 90px;" />
                        </div>
                        <div class="col-sm-4 col-xl-2 mb-5 mb-xl-0">
                            <img src="<?php echo base_url(); ?>assets/website_assets/img/logos/logo-9.png" alt class="img-fluid" style="max-width: 140px;" />
                        </div>
                        <div class="col-sm-4 col-xl-2 mb-5 mb-xl-0">
                            <img src="<?php echo base_url(); ?>assets/website_assets/img/logos/logo-10.png" alt class="img-fluid" style="max-width: 140px;" />
                        </div>
                        <div class="col-sm-4 col-xl-2 mb-5 mb-sm-0">
                            <img src="<?php echo base_url(); ?>assets/website_assets/img/logos/logo-11.png" alt class="img-fluid" style="max-width: 140px;" />
                        </div>
                        <div class="col-sm-4 col-xl-2 mb-5 mb-sm-0">
                            <img src="<?php echo base_url(); ?>assets/website_assets/img/logos/logo-12.png" alt class="img-fluid" style="max-width: 100px;" />
                        </div>
                        <div class="col-sm-4 col-xl-2">
                            <img src="<?php echo base_url(); ?>assets/website_assets/img/logos/logo-13.png" alt class="img-fluid" style="max-width: 100px;" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div role="main" class="main">
                ...
                <!-- <div id="googlemaps" class="google-map mt-0" ></div> -->
                <?php
                foreach ($fetch_contact as $add_info) {
                    $LandLine = $add_info->LandLine;
                    $Cell = $add_info->Cell;
